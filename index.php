                          ...
                          <div class="modal-body">
                                        <form class="form" role="form" method="post" action="index.php" accept-charset="UTF-8">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="register_location" class="form-control" placeholder="location" required>
                                            </div>
                                            <div class="form-group">
                                                <label class="sr-only" for="age">Age</label>
                                                <input type="text" name="register_age" class="form-control" placeholder="age" required>
                                            </div>
                                            <div class="form-group">
                                                <label class="sr-only" for="gender">Gender</label>
                                                <input type="text" name="register_gender" class="form-control" placeholder="gender" required>
                                            </div>
                                            <div class="form-group">
                                                <label class="sr-only" for="password">Password</label>
...
?>
  ...
  <div id="top" >
      <div id="searchbox" class="container-fluid" style="width:112%;margin-left:-6%;margin-right:-4%;">
          <div>
              <form role="search" method="POST" action="Result.php">
                  <input type="text" class="form-control" name="keyword" style="width:40%;margin:20px 10% 20px 10%;" placeholder="Search for a Book , Author Or Category">
              </form>
          </div>
      </div>
  ...
  <div class="container-fluid" id="author">
      ...
      <div class="row">
          <div class="col-sm-5 col-md-3 col-lg-3">
              <a href="Author.php?value=Yaxye%20Yabaash"><img class="img-responsive center-block" src="img/popular-author/0.jpg"></a>
          </div>
          <div class="col-sm-6 col-md-3 col-lg-3">
              <a href="Author.php?value=Maxamed%20Ali "><img class="img-responsive center-block" src="img/popular-author/1.jpg"></a>
          </div>
          <div class="col-sm-6 col-md-3 col-lg-3">
              <a href="Author.php?value=Adna%20Adan%20Ismaciil"><img class="img-responsive center-block" src="img/popular-author/2.jpg"></a>
          </div>
          <div class="col-sm-6 col-md-3 col-lg-3">
              <a href="Author.php?value=Maxamed%20Ibraahim%20Hadraawi "><img class="img-responsive center-block" src="img/popular-author/3.jpg"></a>
          </div>
      </div>
      <div class="row">
          <div class="col-sm-5 col-md-3 col-lg-3">
              <a href="Author.php?value=Maxamed%20Xaashi%20Dhamac"><img class="img-responsive center-block" src="img/popular-author/4.jpg"></a>
          </div>
          <div class="col-sm-6 col-md-3 col-lg-3">
          ...
          <div class="row">
              ...
              <div class="col-sm-7 col-md-5 col-lg-5">
                  ...
                  <div class="row">
                      ...
                      <div class="col-md-6 text-center">
                          ...
                          <p>Cigaal E-BookStore@gmail.com</p>
                      </div>
                  </div>
              </div>
              ...
              <div class="col-sm-4 col-md-3 col-lg-3 text-center">
                  ...
                  <div>
                      ...
                      <a href="https://www.pinterest.com/cigaaldbookstore/">
